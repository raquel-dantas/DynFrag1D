...
if create_mesh == False:
    mesh_file_name = "input_files/mesh_files/mesh_non_uniform_5000.pickle"
...
if generate_limit_stress_variation == False:
    stress_limite_file_name = "input_files/random_stress_files/random_stress_critical_5000.pickle"
...
if continue_simulation_from_step == True:
    # previous_simulation = "output_mesh_study/10to3/10to3_lipfield_uniform_5000/lipfield_step_11990_.pickle"
    previous_simulation = "output_mesh_study/reg_length/5000_10to4_uniform_reg_length_10/lipfield_step_7490_.pickle"


# if use symmetry we have to add the bc proper
half_bar = False

# filepath_save_results = "output_mesh_study/10to5/10to5_lipfield_non_uniform_5000/"
filepath_save_results = "output_mesh_study/reg_length/5000_10to4_uniform_reg_length_10/"
