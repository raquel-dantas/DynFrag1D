...
def GradyFragSizeS(epsilon):
    """Returns the fragment size estimation through analytical formulation proposed by Grady (1982) for a given interval of strain rate."""

    s = (24.* DFMesh.Gc)/(DFMesh.rho * epsilon**2)**(1/3)
...
# DFPlot.Plotlog(values_strainrate, s_grady, "strain rate (s-1)", "Frag. size (m)", "Grady (1982)")
# DFPlot.Plotlog(values_strainrate, s_gc, "strain rate (s-1)", "Frag. size (m)", "Grady (1982)")