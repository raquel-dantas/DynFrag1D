...
if create_mesh == False:
    mesh_file_name = 'src/input_files/mesh_files/mesh_non_uniform_2500.pickle'
...
if generate_limit_stress_variation == False:
    stress_limite_file_name = 'src/input_files/random_stress_files/random_stress_critical_2500.pickle'
...
if continue_simulation_from_step == True:
    previous_simulation = "LOG/mesh_study/lipfield_non_uniform_mesh/2500el/lipfield_step_14990_.pickle"

half_bar = False
# if use symmetry we have to add the bc properly

filepath_save_results = "LOG/mesh_study/lipfield_non_uniform_mesh/2500el/"