...
# Time
time_simulation = 7.0 * 10**-7  # Total time of simulation (s)
...
if continue_simulation_from_step == True:
    previous_simulation = "LOG/mesh_study/lipfield_uniform_mesh/2500el/lipfield_step_3240_.pickle"

half_bar = False
# if use symmetry we have to add the bc properly

filepath_save_results = "LOG/mesh_study/lipfield_uniform_mesh/2500el/"