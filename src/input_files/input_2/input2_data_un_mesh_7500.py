...
if generate_limit_stress_variation == False:
    stress_limite_file_name = 'src/input_files/random_stress_files/random_stress_critical_7500.pickle'
...
if continue_simulation_from_step == True:
    previous_simulation = "LOG/mesh_study/lipfield_uniform_mesh/7500el/lipfield_step_5240_.pickle"


half_bar = False
# if use symmetry we have to add the bc properly

filepath_save_results = "LOG/mesh_study/lipfield_uniform_mesh/7500el/"