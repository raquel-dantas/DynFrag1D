...
def runSimulation(strain_rate):
    ...
    for n in range(DFModel.n_init, DFModel.n_final):
        ...
        results = [["displacement", u],["damage", d], ["stress", stress],["avg_stress_bar", avg_stress_bar],["energies", energies],["n_fragments", n_fragments],["frag_lengths", frag_lengths],["avg_frag_size", avg_frag_size]]
