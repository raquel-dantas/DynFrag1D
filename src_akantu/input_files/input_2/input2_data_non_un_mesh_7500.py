...
if create_mesh == False:
    mesh_file_name = 'src_akantu/input_files/mesh_files/mesh_non_uniform_7500.pickle'
...
if generate_limit_stress_variation == False:
    stress_limit_file_name = 'src_akantu/input_files/random_stress_files/random_stress_critical_7500.pickle'
...
filepath = "src_akantu/LOG/mesh_study/czm_non_uniform_mesh/7500el/"
